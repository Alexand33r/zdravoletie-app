...
\draw[arrow] (features) -- node[right, font=\footnotesize]{reverse-\\engineering} (surrogate);
\draw[arrow] (surrogate) -- (agegap);
\draw[arrow] (surrogate) -- (shap);
\draw[dasharrow] (bodyage) -- node[right, font=\footnotesize]{target\\variable} (agegap);
\end{tikzpicture}
