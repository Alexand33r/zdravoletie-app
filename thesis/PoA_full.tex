...
\begin{table}[h]
  ...
  \begin{tabular}{p{2.2cm} p{11cm}}
    ...
    Information  & Progress communicated to Peter P.A.L. van Alem at the midterm presentation. Decisions logged in the weekly logbook. project constraints document written at phase end to lock project constraints. \\
...
\begin{table}[h]
  ...
  \begin{tabular}{p{2.2cm} p{11cm}}
    ...
    \textbf{Dimension} & \textbf{Measure} \\
    \midrule
    Time         & 40 hours across Weeks 19--20 and the defence period. Milestones: all deliverables submitted (June 22), presentation rehearsal complete (July 3), oral defence delivered (July 3 and July 7). \\
...
The project spans twenty weeks from February 9 to June 22, 2026. Table~\ref{tab:gantt} presents the Gantt schedule across eight work packages. The status key is: D = Done, I = In progress, P = Planned, and a blank cell indicates the work package is not scheduled in that week.
