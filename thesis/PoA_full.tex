...
\begin{table}[h]
  ...
  \begin{tabular}{p{2.2cm} p{11cm}}
    ...
    Information  & Progress communicated to Peter P.A.L. van Alem at the midterm presentation. Decisions logged in the weekly logbook. \texttt{CLAUDE.md} written at phase end to lock project constraints. \\
