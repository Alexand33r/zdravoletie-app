...
The internship logbook documents the student's weekly activities, decisions, and communications across all nineteen project weeks. It provides a verifiable record of professional engagement and serves as supporting evidence for the competency portfolio.
...
\textbf{How:} The student attended the project kickoff at Zdravoletie, explored the Anovator web interface systematically, and began mapping available variables against the project objective. Preliminary modelling was conducted in \texttt{Health\_Pipeline.ipynb} and \texttt{Benchmarking.ipynb} using non-rigorous single-split evaluation. Following the midterm review, a systematic audit of all eight notebooks was conducted, documenting eleven distinct methodological and implementation issues before any fixes were applied, to prevent partial corrections from masking undiscovered problems.

\textbf{Input:} Anovator web interface; Fontys internship guidelines; preliminary notebook pipeline.

\textbf{Output:} Corrected project framing (score reverse-engineering); documented list of eleven bugs; project constraints document establishing the non-negotiable project constraints; \texttt{config.py} establishing the fixed random seed, file paths, cross-validation protocol, model registry, and feature group definitions; \texttt{requirements.txt}; \texttt{make\_all.py}; \texttt{results/} and \texttt{thesis/} directories; \texttt{future\_work.md}.

\textbf{Deliverable:} project constraints document (project charter); Phase 1 stabilisation artefacts.
...
\textbf{Input:} Cleaned dataset from Phase 2; GMM synthetic dataset; experimental design from the project constraints document and \texttt{config.py}.
...
\textbf{Period:} June 22 -- July 7, 2026 (Week 19 onwards).
...
\textbf{Deliverable:} Submission confirmation; oral defence on July 3 and July 7, 2026.

% =============================================================================
\section{Project Control}
% =============================================================================

Project control is specified for each phase across five dimensions following the TOKIO framework: Time, Organisation, Information, Quality, and Money.
...
\begin{table}[H]
  ...
  \begin{tabular}{p{2.2cm} p{11cm}}
    ...
    Organisation & Student is solely responsible for all analysis and documentation. Educational supervisor Peter P.A.L. van Alem provides the primary checkpoint at the midterm review (W11). Company supervisor Kostadin Galchin confirms data access and clinical context at kickoff. \\
    Information  & Progress communicated to Peter P.A.L. van Alem at the midterm presentation. Decisions logged in the weekly logbook. project constraints document written at phase end to lock scope, framing, and engineering conventions. \\
...
\begin{table}[H]
  ...
  \begin{tabular}{p{2.2cm} p{11cm}}
    ...
    Organisation & Student is solely responsible for all writing. Peter P.A.L. van Alem reviews chapter drafts and the competency portfolio. Feedback incorporated before the June 22 hard freeze. \\
    Information  & Chapter drafts shared with Peter P.A.L. van Alem via the designated submission channel. Feedback documented in the logbook. Cross-references between chapters verified in the final editing pass. \\
...
\begin{table}[H]
  ...
  \begin{tabular}{p{2.2cm} p{11cm}}
    ...
    \textbf{Dimension} & \textbf{Measure} \\
    \midrule
    Time         & 40 hours across Week 19 and the defence period. Milestones: all deliverables submitted (June 22), presentation rehearsal complete (July 3), oral defence delivered (July 3 and July 7). \\
    Organisation & Student delivers the oral defence. Peter P.A.L. van Alem chairs the academic assessment. Fontys processes the final grade. \\
    Information  & Submission confirmation archived. Defence slide deck shared with Peter P.A.L. van Alem before the defence date for any final guidance. \\
...
\subsection{Total Hour Estimate}

\begin{table}[H]
  \centering
  \caption{Phase hour estimate.}
  \label{tab:budget}
  \begin{tabular}{llr}
    \toprule
    \textbf{Phase} & \textbf{Period} & \textbf{Hours} \\
    \midrule
    Phase 1: Problem Analysis and Framing  & W1--W11  & 80  \\
    Phase 2: Data Collection and Engineering & W1--W12  & 160 \\
    Phase 3: Modelling and Experimentation & W13--W14 & 80  \\
    Phase 4: Product Development           & W13--W18 & 100 \\
    Phase 5: Validation and Writing        & W8--W19  & 140 \\
    Phase 6: Delivery and Defence          & W19       & 40  \\
    \midrule
    \textbf{Total}                         & \textbf{W1--W19} & \textbf{600} \\
    \bottomrule
  \end{tabular}
\end{table}
...
The project spans nineteen weeks from February 9 to June 22, 2026.

\begin{itemize}
  \item Data extraction and audit: Weeks 1--8
  \item Data preparation and modelling: Weeks 4--12
  \item Experiment 1 (model comparison): Weeks 13--14
  \item Experiment 2 (synthetic data ablation): Weeks 13--14
  \item Experiment 3 (feature group ablation): Weeks 13--14
  \item Streamlit application development: Weeks 13--18
  \item Thesis writing: Weeks 8--19
  \item Competency portfolio: Weeks 15--19
  \item Defence preparation: Week 19
\end{itemize}

The oral defence takes place on July 3, 2026 (product presentation) and July 7, 2026 (academic defence).
...
\begin{table}[H]
  ...
  \begin{tabular}{p{8cm} p{3.5cm} p{2cm}}
    \toprule
    ...
    Competency portfolio first draft & Jun 14, 2026 & Complete \\
    All deliverables submission-ready & Jun 21, 2026 & Complete \\
    Hard freeze: final submission & Jun 22, 2026 & Complete \\
    Oral defence & Jul 3 and Jul 7, 2026 & Planned \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{longtable}{p{0.3cm} p{5.5cm} c c c c p{5.5cm}}
  ...
  R1 & Single researcher: no independent verification of implementation decisions, statistical analysis, or thesis writing. & 3 & 5 & 3 & 45 &
    Systematic pre-fix audit completed before any code changes applied. project constraints document written to lock framing, scope, and engineering conventions as an external constraint. All decisions logged in the weekly logbook. \\[4pt]
  ...
  R6 & Non-technical company supervisor: Galchin cannot provide methodological guidance on the modelling or statistical analysis. & 2 & 5 & 2 & 20 &
    Educational supervisor Peter P.A.L. van Alem is the primary source of methodological guidance. Company supervisor role restricted to domain context and data access confirmation. \\[4pt]
  ...
  R8 & Scope creep: additional experiments or extended feature engineering added beyond the three experiments defined in the project constraints document. & 3 & 3 & 2 & 18 &
    The project constraints document explicitly lists all out-of-scope items. Out-of-scope suggestions redirected to \texttt{future\_work.md} rather than acted upon. \\
\end{longtable}
