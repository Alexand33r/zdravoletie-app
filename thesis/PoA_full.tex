...
\begin{table}[h]
  ...
  \begin{tabular}{p{2.2cm} p{11cm}}
    ...
    Organisation & Student is solely responsible for all analysis and documentation. Educational supervisor Peter P.A.L. van Alem provides the primary checkpoint at the midterm review (W9). Company supervisor Kostadin Galchin confirms data access and clinical context at kickoff. \\
