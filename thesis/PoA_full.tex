...
\textbf{Period:} February 9 -- April 19, 2026 (Weeks 1--10).
...
\textbf{How:} Thesis chapters were written progressively in parallel with the experimental work, with introduction and related work produced during data preparation, methodology during the experiments, and results, discussion, conclusion, abstract, and ethics during and after the product development phase. The academic framing --- score reverse-engineering rather than biological age prediction --- is applied consistently across all chapters. The competency portfolio draws on documented evidence from all five phases, with structured reflection on each Fontys Applied Mathematics graduation competency. The logbook records activities, decisions, and communications for each project week.
...
\begin{table}[h]
  ...
  \begin{tabular}{lllr}
    ...
    \midrule
    Phase 1: Problem Analysis and Framing  & W1--W10  & 80  & \texteuro{}2{,}000 \\
...
\begin{table}[h]
  ...
  \begin{tabular}{p{8cm} p{3cm} p{2cm}}
    ...
    Midterm presentation delivered            & Apr 6, 2026 & Complete \\
